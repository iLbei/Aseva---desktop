...
function changeVal() {
  ...
  var name = "hold " + value + "s";
  if (!edit) {
      boxArr[boxArr.length - 1] = new SignalHolder(90, 30, name, "Signal holder", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'holder', value);
  } else {
...
function biOnInitEx(config, moduleConfigs) {
  ...
  if (edit) {
    ...
    var box = new SignalHolder(90, 30, "hold 0.001s", "Signal holder", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'holder', 0.001);
    boxArr.push(box);
    $('input').val(0.001);
    setConfig();
  };
