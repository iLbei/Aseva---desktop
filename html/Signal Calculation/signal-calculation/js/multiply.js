...
function changeVal() {
  ...
  if (!edit) {
    boxArr[boxArr.length - 1] = new Multiply(90, 30, name, "Multiply number", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'mul_number', value);
  } else {
...
function biOnInitEx(config, moduleConfigs) {
  ...
  if (edit) {
    ...
    var box = new Multiply(90, 30, "x0", "Multiply number", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'mul_number', "x0");
    boxArr.push(box);
    $('input').val(0);
    setConfig();
  };
