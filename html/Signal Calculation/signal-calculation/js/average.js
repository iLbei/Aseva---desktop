...
function changeVal() {
  ...
  if (edit == "false") {
    ...
    boxArr[boxArr.length - 1] = new Box(90, 30, name, "Weighted average", selected_node_id, "orange", rank, 0, 0, parentId, [], true, 'weight_average');
  } else {
...
function biOnInitEx(config, moduleConfigs) {
  ...
  if (edit == "true") {
    ...
    var box = new Box(90, 30, "avg {" + parentId[0] + "}", "Weighted average", selected_node_id, "orange", rank, 0, 0, parentId, [], true, 'weight_average');
    boxArr.push(box);
    setConfig();
  }
  if (biGetLanguage() == 1) {
