...
function changeVal() {
  ...
  var name = "%" + value;
  if (edit == "false") {
    boxArr[boxArr.length - 1] = new Mod(90, 30, name, "Mod number", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'mod', value);
  } else {
...
function biOnInitEx(config, moduleConfigs) {
  ...
  if (edit == "true") {
    ...
    var box = new Mod(90, 30, "%1", "Mod number", selected_node_id, "orange", rank, 0, 0, [boxId], [], true, 'mod', 1);
    boxArr.push(box);
    setConfig();
  };
}
